...
public class SpecialRoutesFilter extends ZuulFilter {
    Logger logger = LoggerFactory.getLogger(SpecialRoutesFilter.class);
    ...
    private ProxyRequestHelper helper = new ProxyRequestHelper(properties);
...
// // // // / / /// / / / / // / 
// Issue here getServiceId() enable to return the serviceID
// it retues null
        ...
        if (abTestRoute!=null && useSpecialRoute(abTestRoute)) {
            String route = buildRouteString(ctx.getRequest().getRequestURI(),
                    ...
                    serviceId);
            logger.debug("builded route: " + route);
